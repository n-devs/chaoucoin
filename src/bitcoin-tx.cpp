...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " chaoucoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  chaoucoin-tx [options] <hex-tx> [commands]  Update hex-encoded chaoucoin transaction\n" +
            "or:     chaoucoin-tx [options] -create [commands]   Create hex-encoded chaoucoin transaction\n" +
            "\n";
