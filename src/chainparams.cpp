...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.chaoucoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.chaoucointools.com");
        vSeeds.emplace_back("dnsseed.chaoucoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.chaoucointools.com");
        vSeeds.emplace_back("seed-b.chaoucoin.loshan.co.uk");
