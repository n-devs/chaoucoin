Chaoucoin Core version *0.15.1* is now available from:

  <https://download.chaoucoin.org/chaoucoin-0.15.1/>
...
A number of changes to the way Chaoucoin Core deals with peer connections and invalid blocks
