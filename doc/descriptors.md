# Support for Output Descriptors in Chaoucoin Core

Since Chaoucoin Core v0.17, there is support for Output Descriptors. This is a
...
on Chaoucoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Chaoucoin Core wallets, a convenience function `combo` is
