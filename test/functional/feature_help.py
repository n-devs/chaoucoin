...
"""Verify that starting chaoucoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start chaoucoin with -h for help text")
        ...
        self.log.info("Start chaoucoin with -version for version information")
        ...
        self.log.info("Start chaoucoind with -fakearg to make sure it does not start")
